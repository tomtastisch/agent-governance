...
export function planInstallation(input: { command: InstallerCommand; state: InstallState; entryPath: string; installationRoot: string; version: string; localRules: boolean; bindingId?: string; }): InstallPlan {
