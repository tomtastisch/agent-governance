...
| `tools.install` | CLI-Tools: `brew bundle --file=~/agent-governance/tools/Brewfile`. Plugins: in `~/.claude/settings.json` unter `enabledPlugins` aktivieren. Manifest: `tools/tools.toml`, Abschnitt `[claude]`. |
